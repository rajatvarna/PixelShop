...
const Shortcut: React.FC<{ keys: string[]; description: string }> = ({ keys, description }) => (
  <div className="flex items-center justify-between py-3 border-b border-gray-200">
    ...
    <div className="flex items-center gap-1">
      {keys.map(key => (
        <kbd key={key} className="px-2 py-1 text-sm font-semibold text-gray-700 bg-gray-100 border border-gray-300 rounded-md">
          {key}
        </kbd>
      ))}
    </div>
...
const ShortcutsModal: React.FC<ShortcutsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="sticky top-0 bg-white/80 backdrop-blur-md p-4 border-b border-gray-200 flex justify-between items-center">
            <h2 id="shortcuts-title" className="text-xl font-bold text-gray-800">
                Keyboard Shortcuts
            </h2>
            <button 
                onClick={onClose}
        ...
        <div className="p-6">
            <div className="mb-6">
                <h3 className="font-semibold text-gray-600 mb-2">Editing</h3>
            ...
            <div>
                <h3 className="font-semibold text-gray-600 mb-2">File</h3>
