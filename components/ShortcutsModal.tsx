...
const Shortcut: React.FC<{ keys: string[]; description: string }> = ({ keys, description }) => (
  <div className="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700">
    ...
    <div className="flex items-center gap-1">
      {keys.map(key => (
        <kbd key={key} className="px-2 py-1 text-sm font-semibold text-gray-700 dark:text-gray-200 bg-gray-100 dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-md">
          {key}
        </kbd>
      ))}
    </div>
    ...
    >
      ...
      >
        <div className="sticky top-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
            ...
            <button 
                onClick={onClose}
                className="p-1 rounded-full text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600 hover:text-gray-600 dark:hover:text-gray-200"
        ...
        <div className="p-6">
            ...
            <div className="mb-6">
                <h3 className="font-semibold text-gray-600 dark:text-gray-400 mb-2">Navigation & View</h3>
                <Shortcut keys={['Hold Space', 'Drag']} description="Pan image" />
                <Shortcut keys={['Scroll Wheel']} description="Zoom in/out" />
                <Shortcut keys={['Alt', 'V']} description="Reset view (zoom & pan)" />
